        ...
        <div className="flex h-screen">
            ...
            <div className="flex w-1/2 p-2 flex-col">
                <div className="flex border-b p-2 w-full">
                    <h1 className="font-semibold text-3xl mx-auto">Page Analysis for PDF</h1>
                </div>

                <p className="p-8">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Perferendis mollitia deserunt saepe!
                </p>
                    ...
                    <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                        <div className="bg-white rounded-full h-8 w-8 flex items-center justify-center">
                            <svg className="h-6 w-6 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3
                                0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
                            </svg>
                        </div>
